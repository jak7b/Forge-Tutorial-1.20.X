...
//            ModBlocks.SAPPHIRE_ORE.get()
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        /*
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SAPPHIRE_BLOCK.get()) // Use BUILDING_BLOCKS category
            .pattern("###")
            .pattern("###")
            .pattern("###")
        ...
        */
        ...
        /// Shapeless Recipe: Sapphire Block → 9 Sapphires
        // Uncomment when ModBlocks.SAPPHIRE_BLOCK is registered
        /*
    ...
    protected static void oreSmelting(
            ...
            ItemLike pResult,
            float pExperience,
            int pCookingTime,  // Fixed typo: was pCookingTIme
            String pGroup
    ) {
        oreCooking(
